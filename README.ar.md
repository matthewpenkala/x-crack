...
يحتاج كل اتصال إلى تعيين فترة مهلة لمنع الحجب بسبب مشاكل الشبكة. نعتزم التحكم في فترة المهلة من خلال سطر أوامر البرنامج ، لذلك يتم تحديد متغير عالمي TimeOut.
